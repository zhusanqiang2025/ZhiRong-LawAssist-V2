...
# PDF 解析服务
from app.services.common.pdf_service import PdfService
...
# ⭐ 使用 Qwen3 模型进行元数据提取和合同审查
QWEN3_API_KEY = settings.QWEN3_API_KEY
QWEN3_API_URL = settings.QWEN3_API_BASE
QWEN3_MODEL = settings.QWEN3_MODEL
QWEN3_ENABLED = settings.QWEN3_ENABLED

if not QWEN3_API_KEY:
    print("警告: QWEN3_API_KEY 未配置，合同审查功能将不可用")
    QWEN3_API_KEY = settings.QWEN3_API_KEY
...
if not QWEN3_API_URL:
    QWEN3_API_URL = settings.QWEN3_API_BASE or "https://api.deepseek.com"

print(f"[配置] Qwen3 模型: {QWEN3_MODEL}, 启用: {QWEN3_ENABLED}")
