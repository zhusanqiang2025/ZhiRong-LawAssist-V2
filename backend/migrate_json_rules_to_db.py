...
# 设置本地数据库环境变量（覆盖 .env 中的 Docker 配置）
os.environ['POSTGRES_SERVER'] = 'localhost'
os.environ['DATABASE_URL'] = 'postgresql://admin:01689101Abc@localhost:5432/legal_assistant_db'
...
# 使用本地数据库连接
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://admin:01689101Abc@localhost:5432/legal_assistant_db')
